...
export default function ListFoodTruck(props: ListFoodTruckProps) {
  ...
  useEffect(() => {
    setLoader(true)
    fetch(
      `${constants.DOWNSTREAM_ENDPOINT}/foodtrucks?filterByCurrentDate=${filterByCurrentDate}`
    )
      .then((res) => res.json())
      .then((data) => {
            ...
            <tr>
              <td colSpan={4}>
                <div className="alert alert-success" role="alert">
                  ...
                  <span>
                    No records found! It looks like we don&apos;t have any food
                    truck records added into the system. Here are few next
                    possible steps(s) for you to follow.
                  </span>
                  <hr />
                  <ol>
                    <li>
                      Would you like to add new food truck using above form?
                    </li>
                    <li>
                      We love to build great products, please feel free to{' '}
                      <a
                        href="https://github.com/hegdeashwin/food-truck-app/issues"
                        target="_blank"
                      >
                        share your feedback(s) or report bug(s)
                      </a>{' '}
                      to our products etc.
                    </li>
                  </ol>
              ...
              <tr key={data._id}>
                ...
                <td>
                  <button
                    ...
                    onClick={(evt) =>
                      onEditHandler(
                        ...
                        data.food_truck_available_date
                      )
                    }
                  >
                    Edit
                  ...
                  <button
                    ...
                    onClick={(evt) => onDeleteHandler(evt, data._id)}
                  >
                    Delete
                  </button>
                </td>
                ...
                {({
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        <label
                          htmlFor="foodTruckAvailableDate"
